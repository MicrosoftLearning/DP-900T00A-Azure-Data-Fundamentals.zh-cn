...
ms.locfileid: "138050690"
---
# <a name="nodejs-abi"></a>Node.js ABI

[![生成状态](https://travis-ci.org/lgeiger/node-abi.svg?branch=v1.0.0)](https://travis-ci.org/lgeiger/node-abi) [![Greenkeeper 徽章](https://badges.greenkeeper.io/lgeiger/node-abi.svg)](https://greenkeeper.io/)


获取给定目标和运行时的 Node ABI，反之亦然。
